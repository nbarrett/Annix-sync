...
export class CustomerPortalCompliance1766001100000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            ADD COLUMN "role" "customer_role_enum" NOT NULL DEFAULT 'customer_admin'
        `);
        ...
        await queryRunner.query(`
            ALTER TABLE "customer_profiles"
            ADD COLUMN "email_verification_token" character varying(500)
        `);
        ...
        // Add email_not_verified to customer_login_failure_reason_enum if it doesn't exist
        await queryRunner.query(`
            DO $$
            BEGIN
                IF NOT EXISTS (
                    ...
                    WHERE t.typname = 'customer_login_failure_reason_enum'
                    AND e.enumlabel = 'email_not_verified'
                ) THEN
                    ALTER TYPE "customer_login_failure_reason_enum" ADD VALUE 'email_not_verified';
                END IF;
            END $$;
        `);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "supplier_invitations" DROP CONSTRAINT IF EXISTS "FK_invitations_supplier"`);
        await queryRunner.query(`ALTER TABLE "supplier_invitations" DROP CONSTRAINT IF EXISTS "FK_invitations_invited_by"`);
        await queryRunner.query(`ALTER TABLE "supplier_invitations" DROP CONSTRAINT IF EXISTS "FK_invitations_company"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "supplier_invitations"`);

        await queryRunner.query(`ALTER TABLE "customer_preferred_suppliers" DROP CONSTRAINT IF EXISTS "FK_preferred_suppliers_added_by"`);
        await queryRunner.query(`ALTER TABLE "customer_preferred_suppliers" DROP CONSTRAINT IF EXISTS "FK_preferred_suppliers_supplier"`);
        await queryRunner.query(`ALTER TABLE "customer_preferred_suppliers" DROP CONSTRAINT IF EXISTS "FK_preferred_suppliers_company"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "customer_preferred_suppliers"`);

        await queryRunner.query(`ALTER TABLE "customer_documents" DROP CONSTRAINT IF EXISTS "FK_customer_documents_reviewed_by"`);
        await queryRunner.query(`ALTER TABLE "customer_documents" DROP CONSTRAINT IF EXISTS "FK_customer_documents_customer"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "customer_documents"`);

        await queryRunner.query(`ALTER TABLE "customer_onboarding" DROP CONSTRAINT IF EXISTS "FK_customer_onboarding_reviewed_by"`);
        await queryRunner.query(`ALTER TABLE "customer_onboarding" DROP CONSTRAINT IF EXISTS "FK_customer_onboarding_customer"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "customer_onboarding"`);

        // Drop columns from customer_profiles
        await queryRunner.query(`ALTER TABLE "customer_profiles" DROP COLUMN IF EXISTS "email_verification_expires"`);
        await queryRunner.query(`ALTER TABLE "customer_profiles" DROP COLUMN IF EXISTS "email_verification_token"`);
        await queryRunner.query(`ALTER TABLE "customer_profiles" DROP COLUMN IF EXISTS "email_verified"`);
        await queryRunner.query(`ALTER TABLE "customer_profiles" DROP COLUMN IF EXISTS "role"`);
